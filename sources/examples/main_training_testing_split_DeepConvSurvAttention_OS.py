...
from model.model import DeepConvSurv_Attention, DeepConvSurv_Attention_testing
...
def main():
    ...
    for iSimulation in range(nSimulation):
        ...
        model = DeepConvSurv_Attention(image_size+[1], (1))
        ...
        model_testing = DeepConvSurv_Attention_testing(image_size + [1])
