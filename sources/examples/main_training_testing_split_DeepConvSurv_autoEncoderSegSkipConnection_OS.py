...
from model.model_DeepConvSurv_autoEncoder import DeepConvSurv_autoEncoder_segSkipConnection, DeepConvSurv_autoEncoder_segSkipConnection_testing
...
def main():
    ...
    for iSimulation in range(nSimulation):
        ...
        model = DeepConvSurv_autoEncoder_segSkipConnection(image_size+[1], (1), image_size+ [len(labels)], len(labels))
        ...
        model_testing = DeepConvSurv_autoEncoder_segSkipConnection_testing(image_size + [1], len(labels))
