...
from model.model_DeepConvSurv_autoEncoder import DeepConvSurv_autoEncoder_imaging_clinics, DeepConvSurv_autoEncoder_imaging_clinics_testing
...
def main():
    ...
    for iSimulation in range(nSimulation):
        ...
        model = DeepConvSurv_autoEncoder_imaging_clinics(image_size+[1], (training_clinics.shape[1]), (1))
        ...
        model_testing = DeepConvSurv_autoEncoder_imaging_clinics_testing(image_size + [1], (training_clinics.shape[1]))
