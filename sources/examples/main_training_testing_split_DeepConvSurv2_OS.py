...
from model.model_DeepConvSurv import DeepConvSurv2, DeepConvSurv2_testing
...
def main():
    ...
    for iSimulation in range(nSimulation):
        ...
        model = DeepConvSurv2(image_size+[1], (1))
        ...
        model_testing = DeepConvSurv2_testing(image_size + [1])
