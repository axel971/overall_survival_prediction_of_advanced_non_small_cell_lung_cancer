...
def main():
    ...
    for iSimulation in range(nSimulation):
        ...
        training_generator = Generator3D_oneClassificationTask_imaging_clinics(training_data, training_clinics, times[train_id], events[train_id], diseaseFailure[train_id], batch_size = 10)
    ...
    print("Disease failure results (AUC)")
