...
from model.model_DeepConvSurv_autoEncoder import DeepConvSurv_seg_imaging_clinics, DeepConvSurv_seg_imaging_clinics_testing
...
def main():
    ...
    for iSimulation in range(nSimulation):
        ...
        model = DeepConvSurv_seg_imaging_clinics(image_size+[1], (1), image_size+ [len(labels)],(training_clinics.shape[1]), len(labels))
        ...
        model_testing = DeepConvSurv_seg_imaging_clinics_testing(image_size + [1],(training_clinics.shape[1]), len(labels))
        ...
        train_pred_delineation = restore_labels_array(train_pred[1], labels)
        ...
        testing_pred_delineation = restore_labels_array(testing_pred[1], labels)
