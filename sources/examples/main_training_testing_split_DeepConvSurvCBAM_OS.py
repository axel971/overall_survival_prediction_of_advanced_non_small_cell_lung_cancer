...
from model.model import DeepConvSurv_CBAM, DeepConvSurv_CBAM_testing
...
def main():
    ...
    for iSimulation in range(nSimulation):
        ...
        model = DeepConvSurv_CBAM(image_size+[1], (1))
        ...
        model_testing = DeepConvSurv_CBAM_testing(image_size + [1])
