...
from model.model_DeepResConvSurv import DeepResConvSurv2, DeepResConvSurv2_testing
...
def main():
    ...
    for iSimulation in range(nSimulation):
        ...
        model = DeepResConvSurv2(image_size+[1], (1))
        ...
        model_testing = DeepResConvSurv2_testing(image_size + [1])
