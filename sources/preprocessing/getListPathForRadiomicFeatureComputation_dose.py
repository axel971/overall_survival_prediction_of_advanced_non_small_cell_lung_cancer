...
output_dir = "/cbica/home/largenta/dev/LANSCLC_project/data/raw_data/listNameFiles/imageAndMaskPathsForRadiomicFeatureComputation_dose.csv"
...
img_dir = '/cbica/home/largenta/dev/LANSCLC_project/data/preprocessing/doses/resampling'
...
for subject_name in subject_names: 
         image_paths.append(img_dir + '/' + subject_name + '_resampled_boundingBox_doses.nii.gz')
